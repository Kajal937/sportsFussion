...
export class DataService {
  ...
  // User Registration (POST request)
  CustomerRegisterUser(data: User): Observable<any> {
    return this.http.post(
      `${this.baseApiUrl}/Equipment/Customerregister`,
      data
    );
  }
  ...
  loginAdmin(data: AdminLoginUser): Observable<any> {
    return this.http.post(`${this.baseApiUrl}/Equipment/adminloginlogin`, data);
  }
  ...
  addProduct(product: Product, categoryName: string): Observable<Product> {
    return this.http.post<Product>(
      `${this.baseApiUrl}/seller/product?category_name=${categoryName}`,
      product
    );
  }
  ...
  updateProduct(id: number, product: Product): Observable<Product> {
    return this.http.put<Product>(
      `${this.baseApiUrl}/seller/productby/${id}`,
      product
    );
  }
  ...
  deleteProduct(id: number): Observable<void> {
    return this.http.delete<void>(
      `${this.baseApiUrl}/seller/productby{id}/${id}`
    );
  }

  // <-----------------  Fetch all orders data for seller pge--------------------->
// Add a new order
  ...
  addSeller(adminSeller: any): Observable<any> {
    return this.http.post<any>(
      `${this.baseApiUrl}/AdminSeller/seller`,
      adminSeller
    );
  }
  ...
  uploadProfileImage(formData: FormData): Observable<any> {
    return this.http.post<any>(
      `${this.baseApiUrl}/admin/profile/upload`,
      formData
    );
  }
  ...
  addToCart(customerId: string, productName: string): Observable<any> {
    const url = `${this.baseApiUrl}/Client?customerId=${encodeURIComponent(
      customerId
  ...
  deleteCartItems(product_id: number): Observable<any> {
    return this.http.delete<void>(
      `${this.baseApiUrl}/Client/cart/${product_id}`
    );
  }
  ...
  getClient(Id: number): Observable<Client> {
    return this.http.get<Client>(
      `${this.baseApiUrl}/Client/get-client-info/${Id}`
    );
  }
  ...
  getOrders(): Observable<Orders[]> {
    return this.http.get<Orders[]>(`${this.baseApiUrl}/AdminSeller/allOrders`); 
  }
  ...
  updateResetPaswword(
    ...
    return this.http.put<Client>(
      `${this.baseApiUrl}/Client/reset-password/${id}`,
      payload
    );
  }
...
//  <---------------------------------seller-profile------------------------------------------->
  ...
  getSellerprofile(id: number): Observable<Seller> {
    return this.http.get<Seller>(
      `${this.baseApiUrl}/Client/get-seller-profile?Id=${id}`
    );
  }

  updateSellerprofile(seller: Seller): Observable<Seller> {
    return this.http.put<Seller>(
      `${this.baseApiUrl}/Client/update-profile-id`,
      seller
    );
  }
  ...
  // <------------------------------admin graph product chart------------------------------------------------------>

  getProductChart(): Observable<ProductGraph[]> {
    return this.http.get<ProductGraph[]>(
      `${this.baseApiUrl}/seller/ProductChart`
    ); 
  }
}
